...
// clear to no light
	memset (blocklights, 0, size * sizeof (unsigned));
...
store:
	...
	case GL_INTENSITY:
		...
		break;
	default:
		Sys_Error ("R_BuildLightMap: Bad lightmap format %d", gl_lightmap_format);
	}
}
