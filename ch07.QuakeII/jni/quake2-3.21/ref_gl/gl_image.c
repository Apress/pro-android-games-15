...
ri.Sys_Error( ERR_DROP, "GL_Upload32: Paletted textures (GL_COLOR_INDEX8_EXT) not supported"); // Vladimir				
...
ri.Sys_Error( ERR_DROP, "GL_Upload8: Paletted textures (GL_COLOR_INDEX8_EXT) not supported"); // Vladimir	
		qglTexImage2D( GL_TEXTURE_2D,
					  0,
					  GL_COLOR_INDEX8_EXT,
					  width,
