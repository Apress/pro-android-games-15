...
// Vladimir int GL_TEXTURE0, GL_TEXTURE1;
...
//		qglTranslatef ( gl_state.camera_separation, 0, 0 );
	...
	// Vladimir - this gives - "Called unimplemented GL ES API - qglGetFloatv (GL_MODELVIEW_MATRIX, r_world_matrix);
...
{	
	...
	*/
	gl_config.vendor_string = "Google Inc"; //qglGetString (GL_VENDOR);
	ri.Con_Printf (PRINT_ALL, "GL_VENDOR: %s\n", gl_config.vendor_string );

	gl_config.renderer_string = "Android Pixel Flinger 1.0"; // qglGetString (GL_RENDERER);
	ri.Con_Printf (PRINT_ALL, "GL_RENDERER: %s\n", gl_config.renderer_string );

	gl_config.version_string = "OpenGL ES-CM 1.0"; //qglGetString (GL_VERSION);
	ri.Con_Printf (PRINT_ALL, "GL_VERSION: %s\n", gl_config.version_string );

	//gl_config.extensions_string = qglGetString (GL_EXTENSIONS);
	gl_config.extensions_string = "GL_OES_byte_coordinates GL_OES_fixed_point GL_OES_single_precision GL_OES_read_format GL_OES_compressed_paletted_texture GL_OES_draw_texture GL_OES_matrix_get GL_OES_query_matrix GL_ARB_texture_compression GL_ARB_texture_non_power_of_two GL_ANDROID_direct_texture GL_ANDROID_user_clip_plane GL_ANDROID_vertex_buffer_object GL_ANDROID_generate_mipmap"; 
	...
	{
		gl_config.allow_cds = false; // Vladimir true;
	}
...
*/	
		...
		strstr( gl_config.extensions_string, "GL_EXT_shared_texture_palette" ) )
	{
		if ( gl_ext_palettedtexture->value )
		{
			...
			// Vladimir qglColorTableEXT = ( void ( APIENTRY * ) ( int, int, int, int, int, const void * ) ) qwglGetProcAddress( "glColorTableEXT" );
		}
		else
		{
