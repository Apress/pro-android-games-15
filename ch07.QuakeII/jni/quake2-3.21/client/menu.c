...
void M_Init (void)
{
	...
	Cmd_AddCommand ("menu_game", M_Menu_Game_f);
		...
		// Vladimir Cmd_AddCommand ("menu_savegame", M_Menu_SaveGame_f);
		Cmd_AddCommand ("menu_load", M_Menu_LoadGame_f);
		Cmd_AddCommand ("menu_save", M_Menu_SaveGame_f);
