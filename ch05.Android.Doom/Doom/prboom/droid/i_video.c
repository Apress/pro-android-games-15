...
void I_UpdateVideoMode(void)
{
  ...
  /* Vladimir
	...
	*/
    ...
    // Vladimir screen = SDL_SetVideoMode(SCREENWIDTH, SCREENHEIGHT, V_GetNumPixelBits(), init_flags);
	jni_printf ("I_UpdateVideoMode: Creating empty surface of %dx%d (%dbpp) flags:0x%x", SCREENWIDTH, SCREENHEIGHT, V_GetNumPixelBits(), init_flags);
	
	// Vladimir screen = (SDL_Surface *)JNI_SurfaceNew(SCREENWIDTH, SCREENHEIGHT, V_GetNumPixelBits(), init_flags);
...
*/
  // Let java know graphics are inited
